...
class superAdminPopUpProfileButton extends StatefulWidget {
  ...
  superAdminPopUpProfileButton({required this.username,required this.curstatus,required this.id});
  @override
  _superAdminPopUpProfileButtonState createState() => _superAdminPopUpProfileButtonState();
}

class _superAdminPopUpProfileButtonState extends State<superAdminPopUpProfileButton> {
